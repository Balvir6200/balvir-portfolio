...
Full Stack Web Developer | Laravel | React | WordPress | WooCommerce

Mohali, Punjab, India  
Phone: +91 98098-66200  
...
Laravel MVC, PHP, React JS, JavaScript, jQuery, Tailwind CSS, HTML5, CSS3, REST APIs, WordPress custom theme development, child theme development, custom plugin development, ACF Pro, WooCommerce setup and customisation, MySQL, SQLite, PostgreSQL, database normalisation, SQL queries, backup and restore, user permissions, SEO best practices, performance optimisation, caching, minification, image optimisation, responsive design, cross-browser compatibility, cPanel, FTP, DNS, Git, GitHub.

## Certifications

### Fundamentals of Artificial Intelligence
Wadhwani Foundation | Certificate of Completion - Basic | May 01, 2026

- Completed 7.5 hours of AI fundamentals training.
- Built foundational understanding of artificial intelligence concepts and learning application.
...
- Delivered live client websites across healthcare, finance, wellness, printing, fitness, travel, agriculture and international markets.

Representative live work: kodegurus.com, printerstechy.com, 800creditnow.com, credencemedicure.com, portal.credencemedicure.com, drharishsharma.com, dietitianshreya.com, fitnessloungegym.com, maximweigh.com, dawnfinancial.in, bajajtravel.com, farmdirect.org.in, xibiti.com, unimartinternational.com, chefscorner.hu.
...
- Focused on scalable product logic for custom print industries instead of simple catalogue-style ecommerce.
...
- Created a clean dashboard experience for scanning and managing daily business operations.
...
Punjab Technical University | 2013 - 2016  
Score: 80.66%

### Diploma in Computer Science Engineering
Chandigarh Technical Board | 2010 - 2013
